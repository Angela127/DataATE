                    ...
                    <tbody>
                        <?php foreach ($customers as $customer): ?>
                            <tr>
                                ...
                                <td><?= !empty($customer->phone) ? htmlspecialchars($customer->phone) : '<em>Not set</em>' ?></td>
                                <td>
                                    <?php
                                    $statusClass = '';
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="<?= BASE_URL ?>/customers/show/<?= $customer->customer_id ?>" class="btn btn-info btn-sm">View</a>
                                        <button 
