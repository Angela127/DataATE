...
@section('content')
    {{-- 可以和 create 共用同一套 style，为简洁这里直接复制 --}}
    <style>
        ...
        .form-error { font-size:12px; color:#B91C1C; margin-top:3px;}
    ...
    <div class="fleet-page-header">
        <div>
            <div class="fleet-page-title">Edit car – {{ $car->plate_no }}</div>
            <div class="fleet-page-subtitle">Update details for this vehicle.</div>
        </div>
    ...
    <div class="fleet-form-card">
        ...
        <form action="{{ route('admin.cars.update', $car->plate_no) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $car->plate_no }}" disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="production_year" name="production_year" value="{{ old('production_year', $car->production_year) }}">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="number" id="engine_cc" name="engine_cc" value="{{ old('engine_cc', $car->engine_cc) }}">
                    @error('engine_cc')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="transmission" name="transmission" value="{{ old('transmission', $car->transmission) }}">
                    @error('transmission')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="drive_type" name="drive_type" value="{{ old('drive_type', $car->drive_type) }}">
                    @error('drive_type')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="top_speed" name="top_speed" value="{{ old('top_speed', $car->top_speed) }}">
                    @error('top_speed')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="max_power" name="max_power" value="{{ old('max_power', $car->max_power) }}">
                    @error('max_power')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="max_torque" name="max_torque" value="{{ old('max_torque', $car->max_torque) }}">
                    @error('max_torque')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="price_hour" name="price_hour" value="{{ old('price_hour', $car->price_hour) }}" required>
                    @error('price_hour')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="fuel_level" name="fuel_level" value="{{ old('fuel_level', $car->fuel_level) }}" required>
                    @error('fuel_level')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="car_mileage" name="car_mileage" value="{{ old('car_mileage', $car->car_mileage) }}" required>
                    @error('car_mileage')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="availability_status" name="availability_status" required>
                        <option value="1" {{ old('availability_status', $car->availability_status) == 1 ? 'selected' : '' }}>Available</option>
                        <option value="0" {{ old('availability_status', $car->availability_status) == 0 ? 'selected' : '' }}>Not available</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="active_status" name="active_status" required>
                        <option value="1" {{ old('active_status', $car->active_status) == 1 ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ old('active_status', $car->active_status) == 0 ? 'selected' : '' }}>Inactive</option>
                    </select>
                    @error('active_status')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
